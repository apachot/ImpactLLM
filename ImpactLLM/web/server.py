    ...
    <section class="tab-panel" id="tab-contact-panel" data-tab-panel="contact">
      <section class="panel reference-panel">
        <div class="summary-body">
          ...
          <p class="notranslate"><a class="profile-link" href="https://emotia.com" target="_blank" rel="noopener noreferrer"><span class="profile-link-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="M12 2a10 10 0 1 0 10 10A10.01 10.01 0 0 0 12 2zm6.93 9h-3.15a15.57 15.57 0 0 0-1.18-5 8.03 8.03 0 0 1 4.33 5zM12 4.04c.88 1.07 1.97 3.38 2.35 6.96H9.65C10.03 7.42 11.12 5.11 12 4.04zM9.4 6a15.57 15.57 0 0 0-1.18 5H5.07A8.03 8.03 0 0 1 9.4 6zM5.07 13h3.15a15.57 15.57 0 0 0 1.18 5 8.03 8.03 0 0 1-4.33-5zM12 19.96c-.88-1.07-1.97-3.38-2.35-6.96h4.7c-.38 3.58-1.47 5.89-2.35 6.96zM14.6 18a15.57 15.57 0 0 0 1.18-5h3.15a8.03 8.03 0 0 1-4.33 5z"/></svg></span><span>Emotia</span></a></p>
