...
\hypersetup{
  ...
  citecolor=black,
  urlcolor=blue,
  pdftitle={ImpactLLM: An Open Tool for Estimating the Environmental Footprint of LLMs},
  pdfauthor={Arnault Pachot and Thierry Petit}
}

\title{ImpactLLM:\\An Open Tool for Estimating the Environmental Footprint of LLMs}
...
\emph{ImpactLLM} is organized around one core design principle: one reusable quantified value per record, with its source and comparability context. The current release contains 76 records spanning 11 core sources and four analytical phases: training, inference, infrastructure, and lifecycle. Each record stores at least a unique identifier, citation, year, analytical phase, impact category, metric name, value, unit, model or scope, geography, data type, source locator, source URL, and free-text note.
...
For completeness, Table \ref{tab:catalog-results} reports the current calculated values for all 29 market models tracked in the March 2026 release. The purpose of this table is documentary: it makes the observatory outputs directly inspectable in the paper, while the web interface remains the primary medium for interactive exploration.

\begin{longtable}{|L{4.0cm}|L{2.0cm}|L{2.2cm}|L{1.7cm}|L{1.8cm}|}
\caption{Calculated environmental indicators for the 29 market models currently tracked by ImpactLLM. Inference values correspond to the standardized one-hour scenario used in the observatory. Training values are extrapolated screening estimates.}\label{tab:catalog-results}\\
\hline
...
\endhead
\hline
GPT-5.2 & 17.59 & 6.77 & 1.17 & 5.23 \\
\hline
GPT-5.2-pro & 17.59 & 6.77 & 1.17 & 5.23 \\
\hline
GPT-5 mini & 5.90 & 2.27 & 0.37 & 1.66 \\
\hline
GPT-5 nano & 5.90 & 2.27 & 0.37 & 1.66 \\
\hline
GPT-OSS 120B & 0.40 & 0.15 & 0.02 & 0.09 \\
\hline
GPT-OSS 20B & 0.26 & 0.10 & 0.01 & 0.06 \\
\hline
Claude Opus 4.1 & 103.53 & 39.86 & 7.83 & 34.84 \\
\hline
Claude Sonnet 4 & 22.44 & 8.64 & 1.57 & 6.97 \\
\hline
Claude 3.5 Sonnet & 10.23 & 3.94 & 0.69 & 3.05 \\
\hline
Claude 3.7 Sonnet & 10.23 & 3.94 & 0.69 & 3.05 \\
\hline
Claude 3.5 Haiku & 1.43 & 0.55 & 0.09 & 0.38 \\
\hline
Gemini 2.5 Pro & 12.46 & 4.80 & 0.78 & 3.48 \\
\hline
Gemini 2.5 Flash & 5.22 & 2.01 & 0.31 & 1.39 \\
\hline
Gemini 2.5 Flash-Lite & 2.06 & 0.79 & 0.12 & 0.52 \\
\hline
Gemini 2.0 Flash & 2.06 & 0.79 & 0.12 & 0.52 \\
\hline
Grok 4 & 38.04 & 14.65 & 2.35 & 10.45 \\
\hline
Llama 3.1 8B & 0.46 & 0.18 & 0.03 & 0.14 \\
\hline
Llama 3.1 70B & 3.61 & 1.39 & 0.27 & 1.22 \\
\hline
Llama 3.1 405B & 19.13 & 7.37 & 1.59 & 7.06 \\
\hline
Ministral 3B & 0.19 & 0.01 & 0.01 & 0.05 \\
\hline
Ministral 8B & 0.49 & 0.02 & 0.03 & 0.14 \\
\hline
Mistral Large & 7.18 & 0.29 & 0.48 & 2.14 \\
\hline
Mistral Small 3.1 24B & 1.43 & 0.06 & 0.09 & 0.42 \\
\hline
Codestral 22B & 1.20 & 0.05 & 0.09 & 0.38 \\
\hline
Qwen2.5 7B & 0.41 & 0.22 & 0.03 & 0.12 \\
\hline
Qwen2.5 32B & 1.72 & 0.93 & 0.13 & 0.56 \\
\hline
Qwen2.5 72B & 3.71 & 2.00 & 0.28 & 1.25 \\
\hline
DeepSeek V3 & 2.76 & 1.49 & 0.14 & 0.64 \\
\hline
DeepSeek R1 & 2.89 & 1.56 & 0.14 & 0.64 \\
\hline
\end{longtable}
...
A second limitation is corpus size. Prompt-level anchors remain scarce, and the method currently relies heavily on Elsworth et al. for the main operational prompt-energy anchor \cite{elsworth2025}. More published request-level benchmarks would improve both calibration and uncertainty framing.

A third limitation concerns scope. The current user-facing estimate is inference-only. Training, embodied hardware impacts, software-system overheads, and water contextualization remain documented in the evidence base, but they are not yet integrated into the personalized screening output.
