...
\noindent The screening proxies themselves are described in full in the companion paper \emph{ImpactLLM Methodology}; the remainder of this article focuses on the resulting observatory outputs.
