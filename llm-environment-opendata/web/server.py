    ...
    <section class="tab-panel" id="tab-contact-panel" data-tab-panel="contact">
      <section class="panel reference-panel">
        <div class="summary-body">
          ...
          <p class="notranslate">Pachot, A., &amp; Petit, T. (2026, March 14). <em><a href="{app_url('/downloads/llm_environment_opendata_paper.pdf')}">ImpactLLM: An open tool for exploring and estimating the environmental footprint of large language models.</a></em></p>
...
<head>
  ...
  <script>
    ...
    const textReplacements = [
      ...
      ['Benchmarks integrated into the chart, all expressed over one hour or rescaled to a comparable order of magnitude: household electricity from Purdue Extension measurements (fluorescent lamp ≈ 9.3 Wh over 1 h; laptop ≈ 32 Wh over 1 h) and a 1500 W electric space heater rescaled here to 11 minutes to obtain ≈ 275 Wh; for carbon, a 10-minute electric-heater benchmark recalculated with the US electricity mix retained by the project (0.25 kWh × 384 gCO2e/kWh ≈ 96 gCO2e), closer to the order of magnitude of the highest models in the inference scenario.', 'Repères intégrés au graphique, tous exprimés sur une heure ou redimensionnés à un ordre de grandeur comparable : consommation électrique domestique issue des mesures de Purdue Extension (lampe fluorescente ≈ 9,3 Wh sur 1 h ; ordinateur portable ≈ 32 Wh sur 1 h) et radiateur électrique de 1500 W ramené ici à 11 minutes pour obtenir ≈ 275 Wh ; pour le carbone, un repère radiateur électrique de 10 minutes recalculé avec le mix électrique américain retenu par le projet (0,25 kWh × 384 gCO2e/kWh ≈ 96 gCO2e), plus proche de l’ordre de grandeur des modèles les plus élevés dans le scénario d’inférence.'],
